...
`));
  ...
  // code/main.js
  Es();
  loadSprite("bean", "sprites/meat.png");
  loadSprite("ghosty", "/sprites/meat.png");
  loadSprite("spike", "/sprites/spike.png");
  loadSprite("grass", "/sprites/snow.png");
  ...
  loadSound("musicScreen", "/sounds/OtherworldlyFoe.mp3");
  ...
  scene("lose", () => {
    add([
      text("You Lose, Mario Be like: LOL")
    ]);
    onKeyPress(() => go("game"));
  });
  scene("win", () => {
  ...
  scene("menu", () => {
    add([
      text("MEAT VS MEAT Press key to start"),
      scale(1)
    ]);
    play("musicScreen");
    onKeyPress(() => go("game"));
